...
public class PlayerUpgradeData : ScriptableObject
{
    ...
    [SerializeField] public float maxHorizontalSpeed = 10f;
    [SerializeField] public float groundAcceleration = 40f;
    [SerializeField] public float airAcceleration = 15f;
    [SerializeField] public float groundLinearDrag = 6f;
    [SerializeField] public float airLinearDrag = 0.5f;
 
    [Header("Jumping")]
    [SerializeField] public float jumpImpulse = 7.5f;
    [SerializeField] public int maxAirJumps = 1;
    [SerializeField] public float coyoteTime = 0.12f;
    [SerializeField] public float jumpBuffer = 0.12f;
    [SerializeField] public float fallGravityMultiplier = 2.0f;
    [SerializeField] public float lowJumpGravityMultiplier = 2.5f;

    [Header("Combat")]
    [SerializeField] public float fireRate = 2f;
    [SerializeField] public float projectileSize = 1f;
    [SerializeField] public float projectileDamage = 10f;
    [SerializeField] public float projectileSpeed = 20f;
    [SerializeField] public float projectileLife = 3f;
    [SerializeField] public int projectilesPerShot = 1;
    [SerializeField] public float projectileSpreadRadius = 0.5f;
    [SerializeField] public float projectileAngleVariance = 5f;
